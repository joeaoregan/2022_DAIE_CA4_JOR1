...
kable(status_data, table.attr = "class=\"table-striped table-hover\"") %>%
...
kable(role_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(team_member_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(work_item_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(project_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(project_team_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(asset_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(asset_work_items_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(library_data, table.attr = "class=\"table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(collection_data, table.attr = "class=\table-striped table-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#28B3F9")
```
...
kable(query1_select_with_where, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
...
kable(query2a_select_with_like, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
```{r select with like}
kable(query2b_select_with_like, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query2c_select_with_like, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
```{r select with or}
kable(query3_select_with_or, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query4_select_with_where_like_or, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
```{r select distinct}
kable(query5_select_distinct, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
```{r select order by}
kable(query6_select_order_by, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query7_select_order_by_asc, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query8_select_order_by_desc, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query9_select_distinct_order_by, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query10a_select_inner_join, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query10b_part1, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query10b_part2, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query10b_part3, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query10b_select_inner_join_2, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
```{r subquery part 1}
kable(query11_subquery_part_1, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
```{r subquery part 2}
kable(query12_subquery_part_2, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query13_subquery_with_select, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query13b_subquery_with_select_not_in, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query14_check_dates, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
...
kable(query15_select_across_date_range, table.attr = "class=\"query-striped query-hover\"") %>%
  kable_styling("striped", "hover") %>%
  row_spec(0, background = "#FF0000")
```
