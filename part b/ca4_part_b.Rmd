...
* **avg_monthly_expenditure_dlc** - average expenditure/month on dowloadable content
...
**β0:** intercept, predicted value of y when x is 0  
**β1:** regression coefficient - how much y changes as x increases  
**ε:** Error of estimate. How much variation exists in estimate of regression coefficient  
...
cor(data$age, data$avg_years_playing_games)
...
correlation between avg_monthly_hrs_gaming and avg_monthly_expenditure_dlc is smallest.
...
```{r}
graph <- ggplot(data, aes(x=avg_monthly_hrs_gaming, y=avg_monthly_expenditure_dlc)) + 
  geom_point()
graph
```
...
No significant relationship between avg_monthly_hrs_gaming and avg_monthly_expenditure_dlc.
