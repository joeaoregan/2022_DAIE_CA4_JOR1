...
<style>
tr:nth-child(even) {background: #AAFFAA;}
tr:hover td {background-color: #44FF44}
</style>
...
asset_img = image_scale(image_crop(er_img, "181x117+184+155"), "175%")
asset_img
```
...
asset_work_items_img = image_scale(image_crop(er_img, "183x62+181+27"), "175%")
...
collection_img = image_scale(image_crop(er_img, "146x61+210+334"), "175%")
collection_img
```
...
library_img = image_scale(image_crop(er_img, "136x62+19+331"), "175%")
library_img
```
...
project_img = image_scale(image_crop(er_img, "182x74+687+322"), "175%")
project_img
```
...
project_team_img = image_scale(image_crop(er_img, "196x61+445+335"), "175%")
project_team_img
```
...
role_img = image_scale(image_crop(er_img, "136x62+709+177"), "175%")
role_img
```
...
status_img = image_scale(image_crop(er_img, "138x63+708+34"), "175%")
status_img
```
...
team_member_img = image_scale(image_crop(er_img, "172x103+462+167"), "175%")
team_member_img
```
...
work_item_img = image_scale(image_crop(er_img, "203x91+439+19"), "175%")
work_item_img
```
...
kable(status_data, caption = "Status Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
...
kable(role_data, caption = "Role Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(team_member_data, caption = "Team Member Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(work_item_data, caption = "Work Item Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(project_data, caption = "Project Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(project_team_data, caption = "Project Team Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(asset_data, caption = "Asset Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(asset_work_items_data, caption = "Asset Work Items Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(collection_data, caption = "Collection Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
...
kable(library_data, caption = "Library Table") %>%
  #    table.attr = 'class="table-striped table-hover"') %>%
  kable_styling("striped") %>%
  row_spec(0, background = "#1AE81A")
```
